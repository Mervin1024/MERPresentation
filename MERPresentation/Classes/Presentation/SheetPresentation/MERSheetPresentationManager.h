...
#import "BFESlidePresentationManager.h"
/**
 *  用来实现以 ActionSheet 形式呈现 ViewController 所做的管理类（自定义弹出框）
 *  使用时需要：
 *  初始化 BFESheetPresentationManager 对象，赋值 effectiveViewSize（最小有效视图Size）
 ...
 *  设置 UIViewController.transitioningDelegate = BFESheetPresentationManager 对象;
 */


@interface MERSheetPresentationManager : BFESlidePresentationManager
